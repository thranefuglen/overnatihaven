          ...
          <div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-4">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-700">Rolige omgivelser</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg
                  className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1"
                ...
                <span className="text-gray-700">Cykelsikkert område</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg
                  className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1"
                ...
                <span className="text-gray-700">Tæt på naturen</span>
              </div>
              <div className="flex items-start space-x-3">
                <svg
                  className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1"
                ...
                <span className="text-gray-700">Hjertelig atmosfære</span>
              </div>
            </div>
          </div>
